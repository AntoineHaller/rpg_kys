...
namespace Rpg_Kys
{
    class Stagiaire : Player
    {
        ...
        public int Attack_Player_Stagiaire()
        {
            ...
            Console.WriteLine("1 - Frappe du bibi(FOR)");
            Console.WriteLine("2 - Esclave des temps modernes(CHAR)");
            Console.WriteLine("3 - Encore en formation(INT)");
            Console.WriteLine("4 - IMMOLATION PAR LE FEU(ULTI)");
