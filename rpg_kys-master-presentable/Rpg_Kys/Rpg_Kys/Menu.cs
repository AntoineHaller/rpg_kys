...
namespace Rpg_Kys
{
    class Menu
    {
        ...
        {
            Console.WriteLine("\nLa partie va commencer!\nAvant toute chose il faut que vous répondiez à quelques questions. =)");
            Game g = new Game();
            g.Choix_Perso();
        }
        ...
        {
            Console.WriteLine("Ce n'est pas grave de céder face à l'adversité. Ou peut être que ca l'est. Le nihilisme n'est pas fait pour tout le monde. =)");
            Thread.Sleep(5000);
            Environment.Exit(0);
        }
    }
